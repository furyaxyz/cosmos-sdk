...
The full specification can be found at [Elysium](https://github.com/elysiumorg/elysium-specs/blob/ec98170398dfc6394423ee79b00b71038879e211/src/specs/data_structures.md#sparse-merkle-tree). In summary:
...
* Joining SMT based camp which has wider and proven adoption than IAVL. Example projects which decided on SMT: Ethereum2, Diem (Libra), Trillan, Tezos, Elysium.
...
* [Elysium (LazyLedger) SMT](https://github.com/lazyledger/smt)
